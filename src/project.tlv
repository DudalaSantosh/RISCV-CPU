   ...
   TLV_fn(riscv_sum_prog, {
      ~assemble(['
         ...
         loop:
            ...
            ADD x10, x14, x0
            SW x10, 4(x0)               # Store final result to register a0 so that it can be read by main program
            LW x15, 4(x1)
            JAL x0,8
   ...
   |cpu
      ...
      @1
         ...
         $imm[31:0] =
                 ...
                 $is_b_instr
                      ? { {20{$instr[31]}}, $instr[7], $instr[30:25], $instr[11:8], 1'd0}:
                 $is_u_instr
                      ? { $instr[31], $instr[30:12], {12'd0}}:
                 $is_j_instr
                      ? { {12{$instr[31]}}, $instr[19:12], $instr[20], $instr[30:21], 1'd0 } : 
                      32'd0;
         //opcode and the instructions decoding 
      ...
      @3
         ...
         $result[31:0] =   $is_andi ? $src1_value & $imm :
                           ...
                           ($is_addi || $is_load || $is_s_instr) ? $src1_value[31:0] + $imm[31:0] :
                           ...
                           $is_slt ? (($src1_value[31] == $src2_value[31]) ? $sltu_rslt[31:0]  : {31'b0, $src1_value[31]}) :
                           $is_slti ? (($src1_value[31] == $imm[31]) ? $sltiu_rslt[31:0] : {31'b0, $src1_value[31]}) :
